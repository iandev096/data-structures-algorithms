...
function mergeSortHelper(mainArr, auxiliaryArr, startIdx, endIdx) {
  if (startIdx === endIdx) {
    return;
  }
...
function doMerge(mainArr, auxiliaryArr, startIdx, middleIdx, endIdx) {
...
const sorted = mergeSort([8, 5, 2, 9, 5, 6, 3]);
